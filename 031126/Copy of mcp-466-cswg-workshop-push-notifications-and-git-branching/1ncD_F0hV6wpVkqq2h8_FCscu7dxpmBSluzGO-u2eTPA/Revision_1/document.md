...
revision:
  id: 1
  timestamp: "2026-03-11T19:57:07.447Z"
---

**Name:** mcp-466-cswg-workshop-push-notifications-and-git-branching  
**Title:** Push notifications and Git branching  
...
*  JJ  
  * Going to Bsides infosec conference on Fri and Sat.…. I gave llm lots of team readmes, asked it to find the perfect schedule, it even listed what project it would benefit: [https://drive.google.com/file/d/1azEsITQOf-v3i40T08VwtKX-kD6Z3TCf/view?usp=sharing](https://drive.google.com/file/d/1azEsITQOf-v3i40T08VwtKX-kD6Z3TCf/view?usp=sharing)    
  * Looked into push notifications  
  * Codespace for collab editor stuff.  I was able to see the same doc from another computer using a codespace earlier this week: [https://github.com/ciwg/collab-codespace](https://github.com/ciwg/collab-codespace)  the collab-codespace tab from my shared doc on the side has photos\!\!  
  * Dog problems  
...
* Donaldo  
  ...
  * Catching up on microelectronics course; coming up with ideas for my design, maybe a [cellular automaton](https://en.wikipedia.org/wiki/Cellular_automaton) or neuron  
  * TXRX is doing a Cable & Harness Assembly training from April 13-May 14  
    * IPC/WHMA-A-620 certification  
      * [whma.org](http://whma.org) \- Wire Harness Manufacturing Association  
...
* [https://gitea.t7a.org/cswg/coordination/src/branch/main/timeline.md](https://gitea.t7a.org/cswg/coordination/src/branch/main/timeline.md)   
...
* Practice repo, not the repo for today's demo, but it has lots of other stuff: [https://github.com/computerscienceiscool/git-practice-repo.git](https://github.com/computerscienceiscool/git-practice-repo.git)  
* Ntfy page: [https://ntfy.sh/nfty-test-jj-2026](https://ntfy.sh/nfty-test-jj-2026)  
  * \*sidenote: its 'TF' not 'FT'  
  * Ntfy's pricing page is nicely worded, friendly in transparency, developer, affordability. [https://ntfy.sh/\#pricing](https://ntfy.sh/#pricing)   
...
* Interesting groups  
  ...
  * [https://mindbrain.ucdavis.edu/](https://mindbrain.ucdavis.edu/)   
  * [https://www.youtube.com/results?search\_query=seth+frey](https://www.youtube.com/results?search_query=seth+frey)   
